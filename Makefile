...
lint-py:  ## run python linter with ruff
	python -m ruff check jupyterlab_singleton_consumer
	python -m ruff format --check jupyterlab_singleton_consumer
...
fix-py:  ## fix python formatting with ruff
	python -m ruff check --fix jupyterlab_singleton_consumer
	python -m ruff format jupyterlab_singleton_consumer
...
test-py:  ## run python tests
	python -m pytest -v jupyterlab_singleton_consumer/tests

# alias
tests-py: test-py

coverage-py:  ## run python tests and collect test coverage
	python -m pytest -v jupyterlab_singleton_consumer/tests --cov=jupyterlab_singleton_consumer --cov-report term-missing --cov-report xml
